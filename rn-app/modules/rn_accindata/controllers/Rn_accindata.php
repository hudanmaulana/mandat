 ...
 */
class Rn_accindata extends CI_Controller {

	protected $tables = 'dataFidusia';
	protected $subject = 'Status Fidusia';
	protected $module;
	...
	public function get()
	{
        ...
        $data = $this->Aaccindata->getDataAll();
	...
	public function edit()
	{
        ...
        /* START DATA EDIT */
        $dtGroups_single = $this->Aaccindata->getDataById($id);
        /* END DATA EDIT */
