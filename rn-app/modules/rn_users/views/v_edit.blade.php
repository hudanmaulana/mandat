...
@section('body')
	<div class="page"  id="page_content" ng-controller="editController">
		<div class="page-header">
			<h1 class="page-title">Form Edit {{$subject}}</h1>
			<ol class="breadcrumb">
										...
										<div class="example">
											<form id="form" action="" method="post" autocomplete="off" enctype="multipart/form-data" accept-charset="utf-8" onsubmit="return false;">
												...
												<div class="form-group form-material">
													<input type="file" class="dropify-event" id="input-file-max-fs" @if($row["avatar"]!=null) data-default-file="{{$imagesfill}}/{{$row["avatar"]}}" @endif data-plugin="dropify" data-max-file-size="2M" data-column="avatar" file-model="avatar" ng-model="avatar" onchange="angular.element(this).scope().uploadImage(this.files,this)" name="avatar" />
												...
												<div class="row">
													<div class="form-group form-material col-md-6">
														...
														<input type="text" class="form-control"  name="username" placeholder="username" value="{{$row["username"]}}"  maxlength="100" autocomplete="off" disabled />
													</div>
													<div class="form-group form-material col-md-6">
														<label class="form-control-label" for="">Email</label>
														<input type="email" class="form-control"  name="email" placeholder="email" value="{{$row["email"]}}"  maxlength="100" autocomplete="off" required />
													</div>
												</div>
												<div class="row">
													<div class="form-group form-material col-md-6">
														<label class="form-control-label" for="">Full Name</label>
														<input type="text" class="form-control"  name="display_name" placeholder="display name" value="{{$row["display_name"]}}"  maxlength="150" autocomplete="off" required />
													</div>
													<div class="form-group form-material col-md-6">
														<label class="form-control-label" for="">Mobile Phone</label>
														<input type="text" class="form-control"  name="mobile" placeholder="mobile phone" value="{{$row["mobile"]}}"  maxlength="14" autocomplete="off" required />
													</div>
												</div>
												...
												<div class="row">
													<div class="form-group form-material  col-md-6">
														...
														<div>
															<div class="radio-custom radio-default radio-inline">
																<input type="radio"  name="active" value="1" @if($row["active"]==1) checked @endif />
																<label for="">Yes</label>
															</div>
															<div class="radio-custom radio-default radio-inline">
																<input type="radio"  name="active" value="0" @if($row["active"]!=1) checked @endif />
																<label for="">No</label>
															</div>
														</div>
													</div>
													<div class="form-group form-material  col-md-6">
														...
														<div>
															<div class="radio-custom radio-default radio-inline">
																<input type="radio" value="male"  name="gender" @if($row["gender"]=='male') checked @endif />
																<label for="">Male</label>
															</div>
															<div class="radio-custom radio-default radio-inline">
																<input type="radio"  value="female" name="gender" @if($row["gender"]=='female') checked @endif />
												...
												<div class="row">
													<div class="form-group form-material col-md-6 ">
														...
														<input type="text" class="form-control"  name="current_location" placeholder="location" value="{{$row["current_location"]}}"  maxlength="100" autocomplete="off" required />
													</div>
													<div class="form-group form-material col-md-6">
														<label class="form-control-label" for="">Password</label>
														<input type="password" class="form-control"  name="password" placeholder=""  maxlength="250" autocomplete="off"/>
													</div>
												</div>
