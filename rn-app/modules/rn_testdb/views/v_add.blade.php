...
<div class="page" id="page_content" ng-controller="editController">
	<div class="page-header">
		<h1 class="page-title">Form  testdb</h1>
		<ol class="breadcrumb">
			<li class="breadcrumb-item"><a href="http://localhost7/mandat/rn">Home</a></li>
			<li class="breadcrumb-item"><a href="{{ base_url() }}rn/{{$module}}">testdb</a></li>
			<li class="breadcrumb-item active">testdb</li>
		</ol>
	</div>
</div>
                                ...
                                <div class="uk-grid uk-grid-divider uk-grid-medium" data-uk-grid-margin>
                                    <div class="uk-width-large-1">
                                        ...
                                        <div class="uk-form-row">
                                            ...
                                            <input class="md-input" id="field-notification_type" name="notification_type" type="text" value="" maxlength="50" />
                                        </div>
                                                                                                                                                                                                                                                                                                                                                                                                                
                                        <div class="uk-form-row">
                                            <label class="uk-form-label" for="field-notification_user">Notification User</label>
                                            <input class="md-input" id="field-notification_user" name="notification_user" type="number" value="" maxlength="20" />
                                        </div>
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        
                                        <div class="uk-form-row">
                                            <label class="uk-form-label" for="field-notification_desc">Notification Desc</label>
                                            <input class="md-input" id="field-notification_desc" name="notification_desc" type="text" value="" maxlength="" />
                                        </div>
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            </div>
                                </div>
                            </div>
                            ...
                            <div class="md-card-content">
                                ...
                                <div id="notification_parent_field_box">
                                    ...
                                    <div id="notification_parent_input_box">
                                                    <span class="uk-form-file md-btn md-btn-primary">
                                                        ...
                                                        <input type="file" data-column="notification_parent" class="gc-file-upload" file-model="notification_parent" ng-model="notification_parent" onchange="angular.element(this).scope().uploadImage(this.files,this)" name="notification_parent">
                                                        <input id="field_notification_parent" class="hidden-upload-input" type="hidden" name="notification_parent" value="">
                                                    </span>
                                        <div id="success_notification_parent" class="upload-success-url" style="display:none;padding-top:7px;">
                                            <a href="" id="file_notification_parent" class="open-file" target="_blank"></a>
                                            <br>
                                            <a href="javascript:void(0)" data-column="notification_parent" id="delete_notification_parent" data-filename="" ng-click="deleteFileClick($event)" class="md-btn md-btn-danger">delete</a>
                                        </div>
                                    </div>
                                </div>
                                <br>
                                ...
                                <div id="notification_status_field_box">
                                    ...
                                    <div id="notification_status_input_box">
                                                    <span class="uk-form-file md-btn md-btn-primary">
                                                        <span>Upload a file</span>
                                                        <input type="file" data-column="notification_status" class="gc-file-upload" file-model="notification_status" ng-model="notification_status" onchange="angular.element(this).scope().uploadImage(this.files,this)" name="notification_status">
                                                        <input id="field_notification_status" class="hidden-upload-input" type="hidden" name="notification_status" value="">
                                                    </span>
                                        <div id="success_notification_status" class="upload-success-url" style="display:none;padding-top:7px;">
                                            <a href="" id="file_notification_status" class="open-file" target="_blank"></a>
                                            <br>
                                            <a href="javascript:void(0)" data-column="notification_status" id="delete_notification_status" data-filename="" ng-click="deleteFileClick($event)" class="md-btn md-btn-danger">delete</a>
                                        </div>
                                    </div>
                                </div>
                                <br>
                                ...
                                <div id="notification_icon_field_box">
                                    ...
                                    <div id="notification_icon_input_box">
                                                    <span class="uk-form-file md-btn md-btn-primary">
                                                        <span>Upload a file</span>
                                                        <input type="file" data-column="notification_icon" class="gc-file-upload" file-model="notification_icon" ng-model="notification_icon" onchange="angular.element(this).scope().uploadImage(this.files,this)" name="notification_icon">
                                                        <input id="field_notification_icon" class="hidden-upload-input" type="hidden" name="notification_icon" value="">
                                                    </span>
                                        <div id="success_notification_icon" class="upload-success-url" style="display:none;padding-top:7px;">
                                            <a href="" id="file_notification_icon" class="open-file" target="_blank"></a>
                                            <br>
                                            <a href="javascript:void(0)" data-column="notification_icon" id="delete_notification_icon" data-filename="" ng-click="deleteFileClick($event)" class="md-btn md-btn-danger">delete</a>
                                        </div>
                                    </div>
                                </div>
                                <br>
                                ...
                                <div class="uk-form-row">
                                    ...
                                    <input class="timepic" id="field-notification_date" name="notification_date" type="text" value="" maxlength="" />
                                </div>
