...
@section('body')
 ...
 <option value="notification_user">Notification User</option>                                                                                  
 <option value="notification_parent">Notification Parent</option>                                                                                  
 <option value="notification_desc">Notification Desc</option>                                                                                  
 <option value="notification_status">Notification Status</option>                                                                                  
 <option value="notification_icon">Notification Icon</option>                                                                                  
 <option value="notification_date">Notification Date</option>                                                                             </select>
                                </div>
                            </div>
                            <div class="uk-form-row">
                                <div class="uk-grid" data-uk-grid-margin="">
 ...
 <td><input class="check_row" type="checkbox" name="checkbox_t.notification_id" ng-checked="checkbox" ng-click="updateSelection($event, t.notification_id)" title="Select"></td>
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                
                                                                                                                                                                                                    
 <td>@{{t.notification_type}}</td>
                                                                                                                                                                                                    
 <td>@{{t.notification_user}}</td>
                                                                                                                                                                                                    
 <td>@{{t.notification_parent}}</td>
                                                                                                                                                                                                    
 <td>@{{t.notification_desc}}</td>
                                                                                                                                                                                                    
 <td>@{{t.notification_status}}</td>
                                                                                                                                                                                                    
 <td>@{{t.notification_icon}}</td>
                                                                                                                                                                                                    
 <td>@{{t.notification_date}}</td>
                                        ...
                                        <td>
                                            <div class="uk-button-dropdown" data-uk-dropdown="{mode:'click'}" aria-haspopup="true" aria-expanded="false">
                                                ...
                                                <div class="uk-dropdown uk-dropdown-small uk-dropdown-bottom" style="">
                                                    <ul class="uk-nav uk-nav-dropdown">
                                                        <li class="edit-row">
                                                            <a href="{{ base_url("cms/$module/edit") }}/@{{t.notification_id}}" title="Edit"><i class="material-icons">mode_edit</i> Edit</a>
                                                        </li>
                                                        <li ng-click="deleteClick(t.notification_id)">
        ...
        app.controller('listController',function($scope, $http)
        {
            ...
            $scope.selectAll = function($event) {
                ...
                for ( var i = 0; i < $scope.data.length; i++) {
                    ...
                    updateSelected(action, entity.notification_id);
                }
            };
