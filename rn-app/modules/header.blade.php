@php
	...
	$avatar = @$user->avatar ? UPLOAD_DIR.'uploads/avatars/'.$user->avatar : UPLOAD_DIR.'uploads/avatars/avatar.png';
	$is_login = ($user->is_login == 1) ? 'avatar-online' : '';

	$dtsetting = get_instance()->rn_default->rn_setting();
@endphp
...
<nav class="site-navbar navbar navbar-default navbar-fixed-top navbar-mega navbar-inverse"
	...
	<div class="navbar-header" style="margin-right: 20px;">
		...
		<div class="navbar-brand navbar-brand-center site-gridmenu-toggle" data-toggle="gridmenu">
			<a href="{{ BASE_URL }}">
			<img class="navbar-brand-logo" src="{{ UPLOAD_DIR.'uploads/'.$dtsetting['site_logo'] }}" title="Remark">
			<span class="navbar-brand-text hidden-xs-down logo-custom"> {{ $dtsetting['site_title'] }}</span>
			</a>
		</div>
	</div>
			...
			<ul class="nav navbar-toolbar navbar-right navbar-toolbar-right">
                ...
                <span class="avatar {{ $is_login }}">
                  ...
                  <i></i>
					...
					<div class="dropdown-menu" role="menu">
						<a class="dropdown-item" href="{{ BASE_URL }}rn/users" role="menuitem"><i class="icon md-account" aria-hidden="true"></i> Profile</a>
						<a class="dropdown-item" href="{{ BASE_URL }}rn/dashboard_setting" role="menuitem"><i class="icon md-settings" aria-hidden="true"></i> Settings</a>
...
<div class="site-menubar">
	<div class="site-menubar-body">
		<ul class="site-menu" data-plugin="menu">
			...
			<li class="site-menu-item has-sub">
				<a href="{{ BASE_URL }}rn/profil" class="animsition-link">
					<i class="site-menu-icon md-account" aria-hidden="true"></i>
					<span class="site-menu-title">Profile</span>
				</a>
			</li>
			<li class="site-menu-item has-sub">
				<a href="{{ BASE_URL }}rn/dashboard_setting" class="animsition-link">
			...
			<div class="dropdown-divider"></div>
			<li class="site-menu-item has-sub">
				<a href="{{ BASE_URL }}logout" class="animsition-link">
