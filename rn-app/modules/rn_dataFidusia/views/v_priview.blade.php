							...
							<div class="example-wrap">
								<div class="example">
										...
										<div class="form-group form-material">
											@if( $status=='terupload')
											<a id="showmenu" style="color:#fff!important;" class="btn btn-danger">Tolak</a>
											@endif
									...
									<form id="form" action="" method="post" autocomplete="off" enctype="multipart/form-data" accept-charset="utf-8" onsubmit="return false;">
										<div style="display: none;" class="menus">
											<div class="form-group form-material"><label class="form-control-label">
													Alasan Tolak
												</label><input  class="form-control" type="hidden" name="no_kontrak" value="{{ $no_kontrak }}" /><textarea  class="form-control" name="alasan"></textarea>
