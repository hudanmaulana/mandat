 ...
 */
class Rn_dataFidusia extends CI_Controller {

	protected $tables = 'dataFidusia';
	protected $subject = 'DataFidusia';
	protected $module;
    ...
    private $rules_ject = array(
        array('field'=> 'alasan', 'label' => 'alasan', 'rules' => 'required'),
    ...
    public function __construct()
	{
		...
		$this->load->model('dataFidusia');
		$this->load->library('mahana_hierarchy');
		$this->columns = array(
			dataFidusia.'.no_kontrak',
		);
		define('uriClass','rn/dataFidusia');
	}
	...
	public function get()
	{
        ...
        $data = $this->dataFidusia->getDataAll();
...
//		}
	...
	public function edit()
	{
        ...
        /* START DATA EDIT */
        $dtGroups_single = $this->dataFidusia->getDataById($id);
        /* END DATA EDIT */
