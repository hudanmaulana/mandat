	...
	<div class="page-content container-fluid">
		<div class="row" data-plugin="matchHeight" data-by-row="true">
						...
						<ul class="list-group list-group-full list-group-dividered mb-0">
								...
								<div class="media">
									<div class="pr-20">
										<a class="avatar avatar-lg" href="javascript:void(0)">
											<img class="img-responsive" src="{asset}/assets/portraits/1.jpg"
												 alt="...">
										</a>
									</div>
							...
							<li class="list-group-item">
								<div class="media">
									<div class="pr-20">
										<a class="avatar avatar-lg" href="javascript:void(0)">
											<img class="img-responsive" src="{asset}/assets/portraits/2.jpg"
												 alt="...">
										</a>
									</div>
									<div class="media-body">
							...
							<li class="list-group-item">
								<div class="media">
									<div class="pr-20">
										<a class="avatar avatar-lg" href="javascript:void(0)">
											<img class="img-responsive" src="{asset}/assets/portraits/3.jpg"
												 alt="...">
										</a>
									</div>
									<div class="media-body">
							...
							<div class="chat">
								<div class="chat-avatar">
									<a class="avatar" data-toggle="tooltip" href="#" data-placement="right" title="">
										<img src="{asset}/assets/portraits/4.jpg" alt="June Lane">
									</a>
								</div>
								<div class="chat-body">
			...
			<div class="col-xl-4 col-lg-6">
				...
				<div class="card card-shadow">
					<div class="card-header cover overlay">
						<div class="cover-background h-200" style="background-image: url('../assets/photos/placeholder.png')"></div>
					</div>
