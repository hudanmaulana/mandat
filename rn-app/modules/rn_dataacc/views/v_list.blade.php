				...
				<div class="panel-body bootstrap-table">
					...
					<table class="table table-hover dataTable table-striped w-full" >
						...
						<tr ng-repeat="t in data">
							...
							<td><small ng-if="t.status=='terupload'"><span class="badge badge-info"> @{{t.status}}</span></small>
								...
								<small ng-if="t.status=='terdaftar'"><span class="badge badge-info"> @{{t.status}}</span></small></td>
