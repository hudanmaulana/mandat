		...
		<div class="page-header">
			...
			<div class="page-header-actions">
				<a class="btn btn-info btn-icon waves-effect waves-classic" href="{{ base_url("rn/$module/add") }}">
					...
					<span class="hidden-sm-down">Add Groups</span>
				</a>
			</div>
		</div>
				...
				<div class="panel-body bootstrap-table">
					...
					<table class="table table-hover dataTable table-striped w-full" >
						...
						<tr ng-repeat="t in data">
							...
							<td><b><span ng-bind-html="t.splashcat">&nbsp;</span><a  href='{{ base_url("rn/$module/edit") }}/@{{t.id}} '> @{{t.name}} </b></a>	 </td>
							<td>@{{t.description}}</td>
							<td>
								<div class="btn-group">
									...
									<div class="dropdown-menu" role="menu">
										...
										<a ng-if="t.id!='1'" class="dropdown-item" style="text-decoration: none !important;" href="{{ base_url("rn/$module/edit") }}/@{{t.id}}" role="menuitem">
											<i class="icon md-edit" aria-hidden="true"></i> Edit
										</a>
										<a ng-if="t.id!='1'" class="dropdown-item" style="text-decoration: none !important;" href="" role="menuitem" ng-click="hapus(t.id)">
