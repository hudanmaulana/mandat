...
class TermModel extends CI_Model
{
	...
	public function getAllByColumn($type, $column=null)
	{
		...
		$data = $this->db->get('rn_terms')->result_array();
	 ...
	 * @return boolean
	 */
	public function add($type, $catId, $postIds,$date,$value)
	{
		$data = array();
		...
		if( !$data ) return 0;
		return $this->db->insert_batch('rn_terms', $data);
	}
	...
	public function remove($type, $catId=null, $postIds=array())
	{
		...
		return $this->db->delete('rn_terms');
	}
}
